...
<div class="pdd-top-100">
  <div class=" content-md" style="position:relative;">
    <div class="row padding-bottom-desktop">
      @foreach( App\Portafolio::where('categoria_id','1')->orderBy('orden','asc')->get() as $portafolio )
...
<div id="myModalCliente" class="modal fade pdddisplay-text" role="dialog" style="text-align:center ">
  <div class="bs-example-modal-lg"  style="display: inline-block;margin: 5% auto 0 auto;">
    <div class="modal-content back-white-modal modal-lg" style="display: inline-block;">
      <button id="close-clientes-cuadro-content" type="button" class="close close-css close-clientes-cuadro-content" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><img src="{{asset('img/close.png')}}" style="width: 80% !important;position: absolute;left: 10%;top: 10%;height: 80%;"></span></button>
